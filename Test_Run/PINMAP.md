...
| 功能 | 引脚 | 外设 | 说明 |
| --- | --- | --- | --- |
| 左电机 PWM | PA16 | TIMA1 CCP1 | 左轮速度输出 |
| 左电机 DIR1 | PA12 | GPIO | AIN1 |
| 左电机 DIR2 | PA13 | GPIO | AIN2 |
| 右电机 PWM | PA22 | TIMA0 CCP1 | 右轮速度输出 |
...
| 功能 | 引脚 | 外设 | 说明 |
| --- | --- | --- | --- |
| 左编码器 A | TBD | GPIO/Timer | 待分配 |
| 左编码器 B | TBD | GPIO/Timer | 待分配 |
| 右编码器 A | TBD | GPIO/Timer | 待分配 |
| 右编码器 B | TBD | GPIO/Timer | 待分配 |
