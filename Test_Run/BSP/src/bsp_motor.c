...
#define BSP_MOTOR_FORWARD_LEFT_SCALE   (98U) //��ƫ�������ٶȽ�һ��
#define BSP_MOTOR_FORWARD_RIGHT_SCALE  (99U) //��ƫ�������ٶȽ�һ��
...
static uint32_t _SpeedToCompare(GPTIMER_Regs *pTimer, uint16_t speed) //����PWM�Ƚ�ֵ  speed����ռ�ձȣ�δӳ�䣩
{
    uint32_t loadValue; //װ��ֵ

    if (pTimer == 0U) { //ָ�뱣��
        return 0U;
    }

    speed = _ClampSpeed(speed); //�ٶ��޷�
...
static void _SetPwmSpeed(uint16_t leftSpeed, uint16_t rightSpeed) //���������ٶ�
{
    ...
    rightCompare = DL_TimerA_getLoadValue(PWM_1_INST) - _SpeedToCompare(PWM_1_INST, rightSpeed);
